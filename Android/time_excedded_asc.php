...
?>
<?php
$sql1="SELECT * FROM bookings WHERE book_timeout IS NULL ORDER BY book_timein ASC";
...
$vehiclenumber = mysql_fetch_assoc($result2);
...
$data2[]= array ('data1'=>$row1,'data2'=>$data1);
}
}
