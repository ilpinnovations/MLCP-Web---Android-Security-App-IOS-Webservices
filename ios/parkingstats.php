...
$data1=array("yesturday_busy_hour"=>$yest_bussiest_hour);
$data2=array("predicted_busy_hour"=>$predict_bussiest_hour);
$data = array();

$query = "SELECT count(*) AS totalslots FROM mlcp_slot";
$result = mysql_query($query,$connection);
$row = mysql_fetch_assoc($result);

$query1 = "SELECT count(*) AS availableslots FROM mlcp_slot WHERE status='Free' AND isReserved='No'";
...
$data=array($row,$row1,$data1,$data2);
